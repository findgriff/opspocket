      ...
      return Padding(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton.icon(
            ...
            onPressed: () {
              // Deploy succeeded — pop back to the server detail screen.
              // The user can then tap the Tunnel → Mission button to open
              // the freshly deployed dashboard in the WebView.
