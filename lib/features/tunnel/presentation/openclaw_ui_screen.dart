...
class OpenClawUiScreen extends StatefulWidget {
  final String url;
  const OpenClawUiScreen({super.key, required this.url});

  @override
  State<OpenClawUiScreen> createState() => _OpenClawUiScreenState();
}

class _OpenClawUiScreenState extends State<OpenClawUiScreen>
  ...
  void initState() {
    ...
    _webController = WebViewController()
      ...
      ..setNavigationDelegate(NavigationDelegate(
        ...
        onWebResourceError: (_) => _onWebReady(),
      ),)
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: _webReady ? _cyan : _cyan.withValues(alpha: 0.4),
                  shape: BoxShape.circle,
                  boxShadow: [BoxShadow(
                    color: _cyan.withValues(alpha: _webReady ? 0.5 : 0.2),
                    blurRadius: 6,
                  ),],
                ),
              ),
                        ...
                        AnimatedBuilder(
                          ...
                          builder: (_, __) => Transform.rotate(
                            ...
                            child: const CustomPaint(
                              size: Size(240, 240),
                              painter: _ArcPainter(color: _cyan),
                            ),
                          ),
                        ),
                        // Logo
                        Image.asset(
                          'assets/openclaw_ui_logo.png',
                          width: 140,
                          height: 140,
                          fit: BoxFit.contain,
                        ),
